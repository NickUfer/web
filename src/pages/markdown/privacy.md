...
protection is of a particularly high priority for the management of the ORY
GmbH. The use of the Internet pages of the ORY GmbH is possible without any
...
protection regulations applicable to the ORY GmbH. By means of this data
...
As the controller, the ORY GmbH has implemented numerous technical and
...
The data protection declaration of the ORY GmbH is based on the terms used by
...
DE  
Phone: -  
Email: [hi@ory.sh](mailto:hi@ory.sh)  
Website: www.ory.sh
...
The Internet pages of the ORY GmbH use cookies. Cookies are text files that are
...
Through the use of cookies, the ORY GmbH can provide the users of this website
...
The website of the ORY GmbH collects a series of general data and information
...
When using these general data and information, the ORY GmbH does not draw any
...
in case of a cyber-attack. Therefore, the ORY GmbH analyzes anonymously
...
On the website of the ORY GmbH, users are given the opportunity to subscribe to
...
The ORY GmbH informs its customers and business partners regularly by means of a
...
The newsletter of the ORY GmbH contains so-called tracking pixels. A tracking
...
embedded tracking pixel, the ORY GmbH may see if and when an e-mail was opened
...
controller. The ORY GmbH automatically regards a withdrawal from the receipt of
...
request the erasure of personal data stored by the ORY GmbH, he or she may, at
any time, contact any employee of the controller. An employee of ORY GmbH shall
...
processing is not required. An employees of the ORY GmbH will arrange the
...
request the restriction of the processing of personal data stored by the ORY
GmbH, he or she may at any time contact any employee of the controller. The
employee of the ORY GmbH will arrange the restriction of the processing.
...
time contact any employee of the ORY GmbH.
...
The ORY GmbH shall no longer process the personal data in the event of the
objection, unless we can demonstrate compelling legitimate grounds for the
processing which override the interests, rights and freedoms of the data
subject, or for the establishment, exercise or defence of legal claims.

If the ORY GmbH processes personal data for direct marketing purposes, the data
...
to the ORY GmbH to the processing for direct marketing purposes, the ORY GmbH
...
her by the ORY GmbH for scientific or historical research purposes, or for
...
employee of the ORY GmbH. In addition, the data subject is free in the context
...
the data subject's explicit consent, the ORY GmbH shall implement suitable
measures to safeguard the data subject's rights and freedoms and legitimate
...
she may, at any time, contact any employee of the ORY GmbH.
...
an online service which allows the placement of advertising on third-party
sites. Google AdSense is based on an algorithm that selects advertisements
displayed on third-party sites to match with the content of the respective
third-party site. Google AdSense allows an interest-based targeting of the
Internet user, which is implemented by means of generating individual user
profiles.
...
website. With each call-up to one of the individual pages of this Internet site,
which is operated by the controller and into which a Google AdSense component is
integrated, the Internet browser on the information technology system of the
data subject will automatically submit data through the Google AdSense component
for the purpose of online advertising and the settlement of commissions to
Alphabet Inc. During the course of this technical procedure, the enterprise
Alphabet Inc. gains knowledge of personal data, such as the IP address of the
data subject, which serves Alphabet Inc., inter alia, to understand the origin
...
Additionally, cookies already in use by Alphabet Inc. may be deleted at any time
...
America. The Alphabet Inc. may disclose the collected personal data through this
