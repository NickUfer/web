...
const HydraPage = () => (
  ...
  >
    <SEO
      description=""
      title={process.env.GATSBY_DOMAIN === 'gethydra.sh' ? 'Open Source OAuth 2.0 and OpenID Connect Server - gethydra.sh' : 'ORY Hydra'}
    />
    <Hero
      ...
      cta={[
        { title: 'Docs', href: 'https://www.ory.sh/docs/hydra', style: 'primary' },
        { title: 'Tutorial', href: 'https://www.ory.sh/docs/hydra/5min-tutorial', style: 'secondary' },
      ]}
    />
    <Newsletter/>
    <Section
      ...
      wide
      right={(
        <img alt="The ORY Hydra login and consent flow" className="responsive" src={integrationAnimation} />
      )}
      mobile={[
        (
          <h3>How ORY Hydra works</h3>
      ...
      right={(
        <>
          ...
          <p>
            ...
            work with any login system and it is easy to customize the login experience.
            Our <a href="https://www.ory.sh/docs/hydra">documentation</a> makes integrating ORY Hydra a snap.
          </p>
        </>
      )}
      mobile={[
    ...
    <Section
      left={(
        <>
          ...
          <p>
            ORY Hydra works with any login system and only a few lines of code are
            required.
          </p>
          <p>
            ORY technology works on the network. It interfaces as little as possible
            with your code so you can concentrate on building your applications.
          </p>
          <p>
            <a href="https://www.ory.sh/docs/hydra/oauth2" className="cta tertiary">Learn more</a>
          </p>
        </>
      )}
      wide
